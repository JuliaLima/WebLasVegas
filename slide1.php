...
<?php
$foto=array("lv1-001.jpg","lv1-002.jpg","lv1-003.jpg","lv1-004.jpg","lv1-005.jpg","lv1-006.jpg","lv1-007.jpg","lv1-008.jpg");
$text=array("lv1-001.jpg","lv1-002.jpg","lv1-003.jpg","lv1-004.jpg","lv1-005.jpg","lv1-006.jpg","lv1-007.jpg","lv1-008.jpg");
?>
</head>
<body>
	...
	<h2 class="centrar">GALERÍA DE FOTOS</h2>
			...
			<?php
				for ($i=0; $i < count($foto); $i++){
					echo '<div class="item"><img src="img/lv1/'.$foto[$i].'"><br />'.$i.'-'.$text[$i].'</div>';
				}
			?>
		<!--		-->
		...
		<div id="sync2" class="owl-carousel">
			...
			<?php
				for ($i=0; $i < count($foto); $i++){
					echo '<div class="item"><img src="img/lv1/'.$foto[$i].'"></div>';
				}
			?>
		<!--		-->
