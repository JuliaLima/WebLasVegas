<html>
  ...
  <link rel="stylesheet" href="estilos/general_foundicons.css">
  <link rel="stylesheet" href="estilos/social_foundicons.css">
...
<?php
$foto=array("lv.jpg","lv1.jpg","lv2.jpg","lv3.jpg");
$text=array("lv.jpg","lv1.jpg","lv2.jpg","lv3.jpg");
?>
</head>
<body>
...
<div class="row">
	<div class="twelve column" >
		...
		<div id="sync1" class="owl-carousel">
			...
			<?php
				for ($i=0; $i < count($foto); $i++){
					echo '<div class="item"><img src="img/'.$foto[$i].'"><br />'.$i.'-'.$text[$i].'</div>';
				}
			?>
		<!--		-->
		...
		<div id="sync2" class="owl-carousel">
			...
			<?php
				for ($i=0; $i < count($foto); $i++){
					echo '<div class="item"><img src="img/'.$foto[$i].'"></div>';
				}
			?>
		<!--		-->
