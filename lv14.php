...
header{
background: url(img/lv1/f1.jpg) no-repeat center center fixed !important;
...
<!----><input type="submit" class="button float-right" value="Enviar1" onclick="cargarContenido('enviar.php')">
