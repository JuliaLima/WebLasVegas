...
<label class="tblanco">Nombre y Apellido<input type="text" name="nombre" id="fnombre"></label>
<label class="tblanco">Dirección de e-mail<input type="email" name="email" id="femail"></label>
<label class="tblanco">Asunto<input type="text" name="asunto" id="fasunto"></label>
<label class="tblanco">Mensaje<textarea name="mensaje" id="fmensaje"></textarea></label>
...
<div class="row negro tblanco">
<div class="small-12 medium-6 columns small-centered">
<button type="button" onclick="cargarContenidoReloj('enviar.php')" class="alert button">Enviar1</button>
